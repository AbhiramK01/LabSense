...
var ArrowDownward_default = createSvgIcon((0, import_jsx_runtime4.jsx)("path", {
...
var TableSortLabel = React12.forwardRef(function TableSortLabel2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableSortLabel"
  });
  ...
  return (0, import_jsx_runtime5.jsxs)(TableSortLabelRoot, {
    className: clsx_default(classes.root, className),
    component: "span",
    disableRipple: true,
    ownerState,
    ref,
    ...other,
    children: [children2, hideSortIcon && !active ? null : (0, import_jsx_runtime5.jsx)(TableSortLabelIcon, {
      as: IconComponent,
...
true ? TableSortLabel.propTypes = {
   ...
   * @default 'asc'
   */
  direction: import_prop_types10.default.oneOf(["asc", "desc"]),
  /**
   * Hide sort icon when active is false.
   * @default false
   */
  hideSortIcon: import_prop_types10.default.bool,
  /**
   * Sort icon to use.
...
//# sourceMappingURL=chunk-BAWNPYSF.js.map
